...
public class PUMConsoleActivity extends Activity {
    ...
    private class MyAdapter extends SimpleAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView mTextView = (TextView)view.findViewById(R.id.ItemText);
            mTextView.setTextColor(Color.RED);
            mTextView.setText(yake);
            return view;
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        download.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) { 
               try {
                   mIComService.downloadPUSConsole();
               } catch  (Exception e) {
        ...
        list.setOnCreateContextMenuListener(new OnCreateContextMenuListener() {
            ...
            public void onCreateContextMenu(ContextMenu menu, View v,ContextMenuInfo menuInfo) {
                ...
                HashMap<String, Object> map = new HashMap<String, Object>();
                listItemAdapter.setString("ccc");
                map.put("ItemImage", "chengyake");
                map.put("ItemTitle", "Level");
                map.put("ItemText", "xxx");
                listItem.add(map);
