    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        upload.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) { 
                ...
                int i;
                if(keyBusy == true || mAddr == null || mSize == null){
        ...
        download.setOnClickListener(new View.OnClickListener() {
            ...
            if(HexDump.hexStringToInt(mAddr, 4) < 0x660000 || HexDump.hexStringToInt(mAddr, 4) > 0x66ffff) {
            ...
            //pre download
            try {
                 while(-1 == mIComService.preDownloadPUSJobdata());
            } catch  (Exception e) {
                 throw new IllegalStateException("upload error", e);
            }

            //write into mem
            for(currentIF=0; currentIF<listItemAdapter.getCount(); currentIF++) {
