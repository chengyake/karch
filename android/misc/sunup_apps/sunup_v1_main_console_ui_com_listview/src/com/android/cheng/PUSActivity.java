...
public class PUSActivity extends Activity {
    ...
    class  ItemClickListener implements OnItemClickListener
    {
        public void onItemClick(AdapterView<?> arg0,//The AdapterView where the click happened 
            ...
            switch(arg2) {
                case 0:
                    intent.setClass(PUSActivity.this, ConsoleActivity.class);
                    startActivity(intent);
                    break;
                case 1:
                    intent.setClass(PUSActivity.this, ErrorDataActivity.class);
                    startActivity(intent);
                    break;
                case 2:
                    intent.setClass(PUSActivity.this, JobDataActivity.class);
                    startActivity(intent);
                    break;
                case 4:
                    intent.setClass(PUSActivity.this, TimeActivity.class);
                    startActivity(intent);
                case 5:
                    intent.setClass(PUSActivity.this, CLPWActivity.class);
                    startActivity(intent);
                    break;
                default:
                    break;
