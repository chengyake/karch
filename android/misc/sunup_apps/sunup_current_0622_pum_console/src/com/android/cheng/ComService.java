...
public class ComService extends Service {
    ...
    private String cpuType=UART_PUS;
   ...
   class ReadThread extends Thread {
        ...
        public void run() {
            ...
            while(true) {
                ...
                cmd="\2" + cmd + "\3";
                try {
                    mDriver.write(cmd.getBytes(), READ_WAIT_MILLIS);
                } catch (IOException e) {
...
/**************************************************/
        ...
        public int preDownloadPUSJobdata() {
        ...
        public int flashPUSJobdata() {
            return mService.get().writeAsync(CodeInfo.DOWNLOAD_PUS_JOBDATA_FLASH_C);
        }
