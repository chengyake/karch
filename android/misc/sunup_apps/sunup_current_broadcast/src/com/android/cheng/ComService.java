...
public class ComService extends Service {
    ...
    private static final int MESSAGE_BEATS = 0;
    ...
    private Handler mDebug = new Handler() {
        ...
        public void dispatchMessage(Message msg) {
            if (MESSAGE_DEBUG == msg.what) {
                ...
                Log.e("getVersionInfo", "---------4---------- " + rsp + " chk:" + chk);  
                if(chk == null) {
...
/**************************************************/
        ...
        //pus console
        public int uploadPUSConsole( ) {
            return mService.get().writeAsync(CodeInfo.UPLOAD_PUS_CONSOLE_C);
        }
